...
public abstract class BleScanPresenterLollipop extends ScanCallback{
    ...
    public BleScanPresenterLollipop(String[] names, String mac, boolean fuzzy, boolean needConnect, long timeOut) {
